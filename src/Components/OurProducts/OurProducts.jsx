...
function OurProducts() {
  return (
    ...
    <div className='container mx-auto ourProduct_section' id="Our_ProductSection">
        <div className="">
          <h2 className='hedline_style'>Our  Products</h2>
        <img src="../images/Underline 3 (1).png" alt="" />
        </div>
        <div className="display-flex hedlineSection">
        ...
        <img src="../images/Mockup 1.png" alt="" width="100%" />
            ...
            <div className="display-flex col-6 padding-left ">
                <div>
